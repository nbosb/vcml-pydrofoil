    ...
    -> std::unordered_map<Funct, std::function<void(PythonTask&)>>
{
    return {
            {
            Funct::Init, [&pycore](PythonTask &task){  // the lambda should keep a referece of PydrofoilCore
                #if PROFILING
                    Profiler t("Init");
                #endif
            ...
            {
            Funct::SetCb, [&pycore](PythonTask &task){
                #if PROFILING
                    Profiler t("SetCb");
                #endif
            ...
            {
            Funct::GetCycles, [&pycore](PythonTask &task){
                #if PROFILING
            ...
            {
            Funct::SetBrkp, [&pycore](PythonTask &task){
                #if PROFILING
                    Profiler t("SetBrkp");
                #endif
            ...
            {
            Funct::RemoveBrkp, [&pycore](PythonTask &task){
                #if PROFILING
            ...
            {
            Funct::Simulate, [&pycore](PythonTask &task){
                #if PROFILING
                    Profiler t("Simulate");
                #endif
            ...
            {
            Funct::WriteReg, [&pycore](PythonTask &task){
                #if PROFILING
                    Profiler t("WriteReg");
                #endif
            ...
            {
            Funct::ReadReg, [&pycore](PythonTask &task){
                #if PROFILING
                    Profiler t("ReadReg");
                #endif
            ...
            {
            Funct::FreeCpu, [&pycore](PythonTask &task){
                #if PROFILING
                    Profiler t("FreeCpu");
                #endif
            ...
            {
            Funct::SetVerbosity, [&pycore](PythonTask &task){
                #if PROFILING
            ...
            {
            Funct::SetDMI, [&pycore](PythonTask &task){
                #if PROFILING
                    Profiler t("SetDMI");
                #endif
